...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3" xmlns:util="urn:hl7:utilities" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:uuid="http://www.uuid.org" xmlns:local="urn:fhir:stu3:functions" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <!-- ================================================================== -->
    <!--
        TBD
    -->
                ...
                <xsl:for-each select="interpretatie_vlaggen">
                    <xsl:call-template name="makeCode">
                        ...
                        <xsl:with-param name="codeMap" as="element(map)*">
                            <map inCode="281302008" inCodeSystem="{$oidSNOMEDCT}" code="H" codeSystem="{$oidHL7ObservationInterpretation}" codeSystemName="{$oidMap[@oid=$oidHL7ObservationInterpretation]/@displayName}" displayName="High" xmlns=""/>
                            <map inCode="281300000" inCodeSystem="{$oidSNOMEDCT}" code="L" codeSystem="{$oidHL7ObservationInterpretation}" codeSystemName="{$oidMap[@oid=$oidHL7ObservationInterpretation]/@displayName}" displayName="Low" xmlns=""/>
                            <map inCode="11896004" inCodeSystem="{$oidSNOMEDCT}" code="I" codeSystem="{$oidHL7ObservationInterpretation}" codeSystemName="{$oidMap[@oid=$oidHL7ObservationInterpretation]/@displayName}" displayName="Intermediate" xmlns=""/>
                            <map inCode="30714006" inCodeSystem="{$oidSNOMEDCT}" code="R" codeSystem="{$oidHL7ObservationInterpretation}" codeSystemName="{$oidMap[@oid=$oidHL7ObservationInterpretation]/@displayName}" displayName="Resistant" xmlns=""/>
                            <map inCode="131196009" inCodeSystem="{$oidSNOMEDCT}" code="S" codeSystem="{$oidHL7ObservationInterpretation}" codeSystemName="{$oidMap[@oid=$oidHL7ObservationInterpretation]/@displayName}" displayName="Susceptible" xmlns=""/>
                        </xsl:with-param>
                    </xsl:call-template>
                </xsl:for-each>
