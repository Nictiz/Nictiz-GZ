...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:local="#local.2024011509165874102830100" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <!-- ================================================================== -->
    <!--
        TBD
    -->
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.3.10.1.100_20170602000000" match="naamgegevens">
        ...
        <xsl:param name="unstructuredNameElement" as="xs:string?" select="'ongestructureerde_naam'">
            <!-- if your ada definition has an unstructuredNameElement, give the name of it, defaults to ongestructureerde_naam -->
        </xsl:param>

        <xsl:variable name="varNaamgegevens" select="                 if ($naamgegevens/naamgegevens) then                     $naamgegevens/naamgegevens                 else                     $naamgegevens"/>
                ...
                <xsl:variable name="adaProblem" as="element()*">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="$theProblem[@datatype = 'reference'][not(@value)][@nullFlavor]">
                            <probleem conceptId="{$theProblem[1]/@conceptId}" xmlns="">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.7.10.56_20190916154439" match="lichaamstemperatuur | body_temperature" mode="HandleBodyTemperature">
        ...
        <observation classCode="OBS" moodCode="EVN">
            ...
            <code code="8310-5" displayName="Body temperature" codeSystem="{$oidLOINC}" codeSystemName="{$oidMap[@oid=$oidLOINC]/@displayName}"/>
