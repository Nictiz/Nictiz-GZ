...
<xsl:stylesheet xmlns="http://www.w3.org/1999/XSL/Transform" xmlns:hl7="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" version="2.0">
        ...
        <rubricCluster xmlns="urn:hl7-org:v3" classCode="CLUSTER" moodCode="EVN">
            ...
            <xsl:for-each select="bedreiging_fysiek_milieu">
                <component>
                    ...
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.40827">
            ...
            <xsl:for-each select="er_zijn_blijvende_zorgen_dat_de_opvoed_enof_opgroeisituatie_van_de_jeugdige_een_bedreiging_voor_de_veiligheid_van_de_jeugdige_kunnen_vormen">
                <component>
                    ...
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.41569">
                        <xsl:with-param name="W0639_HL7_W0646_HL7_W0647_HL7" select="$W0639_HL7_W0646_HL7_W0647_HL7"/>
                    </xsl:call-template>
                </component>
            </xsl:for-each>
            <xsl:for-each select="de_blijvende_zorgen_zijn_gedeeld_met_de_jeugdigeoudersverzorgers">
                <component>
                    <!-- Template :: obs Er zijn (blijvende) zorgen dat de opvoed- en/of opgroeisituatie van de jeugdige een bedreiging voor de veiligheid van de jeugdige kunnen vormen -->
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.41570">
                        <xsl:with-param name="W0639_HL7_W0646_HL7_W0647_HL7" select="$W0639_HL7_W0646_HL7_W0647_HL7"/>
                    </xsl:call-template>
                </component>
            </xsl:for-each>
            <xsl:for-each select="reden_om_blijvende_zorgen_niet_te_delen">
                <component>
                    <!-- Template :: obs Er zijn (blijvende) zorgen dat de opvoed- en/of opgroeisituatie van de jeugdige een bedreiging voor de veiligheid van de jeugdige kunnen vormen -->
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.41571">
                        <xsl:with-param name="W0639_HL7_W0646_HL7_W0647_HL7" select="$W0639_HL7_W0646_HL7_W0647_HL7"/>
                    </xsl:call-template>
                </component>
            </xsl:for-each>
            <xsl:for-each select="afwegingsvraag_1_is_er_een_vermoeden_van_dreiging_van_huiselijk_geweld_enof_kindermishandelingq">
                <component>
                    <!-- Template :: obs Er zijn (blijvende) zorgen dat de opvoed- en/of opgroeisituatie van de jeugdige een bedreiging voor de veiligheid van de jeugdige kunnen vormen -->
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.41572">
                        <xsl:with-param name="W0639_HL7_W0646_HL7_W0647_HL7" select="$W0639_HL7_W0646_HL7_W0647_HL7"/>
                    </xsl:call-template>
                </component>
            </xsl:for-each>
            <xsl:for-each select="afwegingsvraag_2_is_er_sprake_van_acute_onveiligheid_enof_structurele_onveiligheidq">
                <component>
                    <!-- Template :: obs Er zijn (blijvende) zorgen dat de opvoed- en/of opgroeisituatie van de jeugdige een bedreiging voor de veiligheid van de jeugdige kunnen vormen -->
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.41573">
                        <xsl:with-param name="W0639_HL7_W0646_HL7_W0647_HL7" select="$W0639_HL7_W0646_HL7_W0647_HL7"/>
                    </xsl:call-template>
                </component>
            </xsl:for-each>
            <xsl:for-each select="afwegingsvraag_3_ben_ik_als_jgzprofessional_in_staat_effectieve_hulp_te_bieden_of_te_organiserenq">
                <component>
                    <!-- Template :: obs Er zijn (blijvende) zorgen dat de opvoed- en/of opgroeisituatie van de jeugdige een bedreiging voor de veiligheid van de jeugdige kunnen vormen -->
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.41574">
                        <xsl:with-param name="W0639_HL7_W0646_HL7_W0647_HL7" select="$W0639_HL7_W0646_HL7_W0647_HL7"/>
                    </xsl:call-template>
                </component>
            </xsl:for-each>
            <xsl:for-each select="afwegingsvraag_4_aanvaarden_de_betrokkenen_de_hulpq_ben_ik_in_staat_de_hulp_te_bieden_of_te_organiserenq">
                <component>
                    <!-- Template :: obs Er zijn (blijvende) zorgen dat de opvoed- en/of opgroeisituatie van de jeugdige een bedreiging voor de veiligheid van de jeugdige kunnen vormen -->
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.41575">
                        <xsl:with-param name="W0639_HL7_W0646_HL7_W0647_HL7" select="$W0639_HL7_W0646_HL7_W0647_HL7"/>
                    </xsl:call-template>
                </component>
            </xsl:for-each>
            <xsl:for-each select="afwegingsvraag_5_leidt_de_hulp_binnen_de_gewenste_termijn_tot_duurzame_veiligheid_enof_het_welzijn_van_alle_betrokkenenq">
                <component>
                    <!-- Template :: obs Er zijn (blijvende) zorgen dat de opvoed- en/of opgroeisituatie van de jeugdige een bedreiging voor de veiligheid van de jeugdige kunnen vormen -->
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.41576">
                        <xsl:with-param name="W0639_HL7_W0646_HL7_W0647_HL7" select="$W0639_HL7_W0646_HL7_W0647_HL7"/>
                    </xsl:call-template>
                </component>
            </xsl:for-each>
            <xsl:for-each select="risicoinventarisatie_vgv">
                <component>
                    ...
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.40739">
                        <xsl:with-param name="W0639_HL7_W0646_HL7_W0647_HL7" select="$W0639_HL7_W0646_HL7_W0647_HL7"/>
                    </xsl:call-template>
                </component>
            </xsl:for-each>
            <xsl:for-each select="risicoinschatting_vgv_op_dit_moment">
                <component>
                    ...
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.41414">
                        <xsl:with-param name="W0639_HL7_W0646_HL7_W0647_HL7" select="$W0639_HL7_W0646_HL7_W0647_HL7"/>
                    </xsl:call-template>
                </component>
            </xsl:for-each>
            <xsl:for-each select="verklaring_tegen_vgv_meegegeven">
                <component>
                    ...
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.41415">
                        <xsl:with-param name="W0639_HL7_W0646_HL7_W0647_HL7" select="$W0639_HL7_W0646_HL7_W0647_HL7"/>
                    </xsl:call-template>
                </component>
            </xsl:for-each>
            <xsl:for-each select="bijzonderheden_vgv">
                <component>
                    ...
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.100.41416">
                        <xsl:with-param name="W0639_HL7_W0646_HL7_W0647_HL7" select="$W0639_HL7_W0646_HL7_W0647_HL7"/>
                    </xsl:call-template>
                </component>
            </xsl:for-each>
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.40827">
        <xsl:param name="W0639_HL7_W0646_HL7_W0647_HL7" as="element()*" required="yes"/>
        <observation xmlns="urn:hl7-org:v3" classCode="OBS" moodCode="EVN" negationInd="false">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.41569">
        <xsl:param name="W0639_HL7_W0646_HL7_W0647_HL7" as="element()*" required="yes"/>
        <observation xmlns="urn:hl7-org:v3" classCode="OBS" moodCode="EVN" negationInd="false">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.41570">
        <xsl:param name="W0639_HL7_W0646_HL7_W0647_HL7" as="element()*" required="yes"/>
        <observation xmlns="urn:hl7-org:v3" classCode="OBS" moodCode="EVN" negationInd="false">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.41571">
        <xsl:param name="W0639_HL7_W0646_HL7_W0647_HL7" as="element()*" required="yes"/>
        <observation xmlns="urn:hl7-org:v3" classCode="OBS" moodCode="EVN" negationInd="false">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.41572">
        <xsl:param name="W0639_HL7_W0646_HL7_W0647_HL7" as="element()*" required="yes"/>
        <observation xmlns="urn:hl7-org:v3" classCode="OBS" moodCode="EVN" negationInd="false">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.41573">
        <xsl:param name="W0639_HL7_W0646_HL7_W0647_HL7" as="element()*" required="yes"/>
        <observation xmlns="urn:hl7-org:v3" classCode="OBS" moodCode="EVN" negationInd="false">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.41574">
        <xsl:param name="W0639_HL7_W0646_HL7_W0647_HL7" as="element()*" required="yes"/>
        <observation xmlns="urn:hl7-org:v3" classCode="OBS" moodCode="EVN" negationInd="false">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.41575">
        <xsl:param name="W0639_HL7_W0646_HL7_W0647_HL7" as="element()*" required="yes"/>
        <observation xmlns="urn:hl7-org:v3" classCode="OBS" moodCode="EVN" negationInd="false">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.41576">
        <xsl:param name="W0639_HL7_W0646_HL7_W0647_HL7" as="element()*" required="yes"/>
        <observation xmlns="urn:hl7-org:v3" classCode="OBS" moodCode="EVN" negationInd="false">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.40739">
        <xsl:param name="W0639_HL7_W0646_HL7_W0647_HL7" as="element()*" required="yes"/>
        <observation xmlns="urn:hl7-org:v3" classCode="OBS" moodCode="EVN" negationInd="false">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.41414">
        <xsl:param name="W0639_HL7_W0646_HL7_W0647_HL7" as="element()*" required="yes"/>
        <observation xmlns="urn:hl7-org:v3" classCode="OBS" moodCode="EVN" negationInd="false">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.41415">
        <xsl:param name="W0639_HL7_W0646_HL7_W0647_HL7" as="element()*" required="yes"/>
        <observation xmlns="urn:hl7-org:v3" classCode="OBS" moodCode="EVN" negationInd="false">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.41416">
        <xsl:param name="W0639_HL7_W0646_HL7_W0647_HL7" as="element()*" required="yes"/>
        <observation xmlns="urn:hl7-org:v3" classCode="OBS" moodCode="EVN" negationInd="false">
