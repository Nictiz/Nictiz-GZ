...
<rule abstract="true"
   ...
   <assert role="error"
           ...
           see="https://art-decor.org/mediawiki/index.php?title=DTr1_AD">dtr1-9-AD: [RIM-001] 
...
<value-of select="$name"/> elements which are not null</assert>
   <assert role="error"
           ...
           see="https://art-decor.org/mediawiki/index.php?title=DTr1_AD">dtr1-10-AD: [RIM-002] 
