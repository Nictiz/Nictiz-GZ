...
<schema queryBinding="xslt2"
   ...
   <title>Schematron file for transaction Sturen medicatievoorschrift MP9 2.0.0 (2.16.840.1.113883.2.4.3.11.60.20.77.4.322 2022-02-07T00:00:00)</title>
   ...
   <!-- Include the project schematrons related to scenario mp92_vos -->
   <!-- MPBaseVoorschrift5 -->
   <pattern>
      <title>MPBaseVoorschrift5</title>
      <rule fpi="RUL-EXPEL"
            context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9329']] | descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9328']]"
                 see="http://decor.nictiz.nl/pub/medicatieproces/mp-html-20220402T205710/tmp-2.16.840.1.113883.2.4.3.11.60.20.77.10.9330-2020-10-15T134355.html">(MPBaseVoorschrift5): In de instance werd tenminste één van de volgende elementen verwacht: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9329']] | descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9328']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9330-2020-10-15T134355.sch"/>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9330-2020-10-15T134355-closed.sch"/>
   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9330-2020-10-15T134355"/>
      ...
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.7.10.30-2021-07-01T000000"/>
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.7.10.54-2019-05-31T125008"/>
   </phase>
   <phase id="MPBaseVoorschrift5">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9330-2020-10-15T134355"/>
   </phase>
   <phase id="MPBaseVoorschrift5-closed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9330-2020-10-15T134355-closed"/>
   </phase>
   <phase id="kleding">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.121.10.14-2021-07-01T000000"/>
   </phase>
   ...
   <!-- lichaamslengte -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.7.10.30-2021-07-01T000000.sch"/>
