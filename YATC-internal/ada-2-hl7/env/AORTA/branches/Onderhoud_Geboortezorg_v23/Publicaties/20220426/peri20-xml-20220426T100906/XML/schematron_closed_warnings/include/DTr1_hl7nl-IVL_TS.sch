...
<rule abstract="true"
   ...
   <assert test="empty($theTSLow) or ($theTSLow=$theTSStringLow and $theLowDateTime castable as xs:dateTime)"
           see="https://art-decor.org/mediawiki/index.php?title=DTr1_hl7nl:IVL_TS">DTr2-9-hl7nl-IVL_TS: 
...
<value-of select="$theTSLow"/>" is not a valid timestamp.</assert>
   ...
   <assert test="empty($theTSCenter) or ($theTS=$theTSStringCenter and $theCenterDateTime castable as xs:dateTime)"
           see="https://art-decor.org/mediawiki/index.php?title=DTr1_hl7nl:IVL_TS">DTr2-9-hl7nl-IVL_TS: 
