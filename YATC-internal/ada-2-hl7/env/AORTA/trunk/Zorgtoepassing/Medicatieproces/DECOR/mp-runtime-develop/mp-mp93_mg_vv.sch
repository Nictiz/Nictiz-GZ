...
<schema queryBinding="xslt2"
   ...
   <title>Schematron file for transaction Beschikbaarstellen verstrekkingsverzoeken MP9 3.0.0 (2.16.840.1.113883.2.4.3.11.60.20.77.4.383 2022-06-30T00:00:00)</title>
   ...
   <!-- Include the project schematrons related to scenario mp93_mg_vv -->
   <!-- MPHL7VerstrekkingsverzoekenOrganizer4 -->
   <pattern>
      <title>MPHL7VerstrekkingsverzoekenOrganizer4</title>
      <rule fpi="RUL-EXPEL"
            context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9450']]"
                 see="http://decor.nictiz.nl/pub/medicatieproces/mp-html-develop/tmp-2.16.840.1.113883.2.4.3.11.60.20.77.10.9450-2023-01-06T094251.html">(MPHL7VerstrekkingsverzoekenOrganizer4): In de instance werd het volgende element verwacht: descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9450']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9450-2023-01-06T094251.sch"/>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9450-2023-01-06T094251-closed.sch"/>
   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9450-2023-01-06T094251"/>
   ...
   <phase id="MPHL7VerstrekkingsverzoekenOrganizer4">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9450-2023-01-06T094251"/>
   </phase>
   <phase id="MPHL7VerstrekkingsverzoekenOrganizer4-closed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9450-2023-01-06T094251-closed"/>
   </phase>
