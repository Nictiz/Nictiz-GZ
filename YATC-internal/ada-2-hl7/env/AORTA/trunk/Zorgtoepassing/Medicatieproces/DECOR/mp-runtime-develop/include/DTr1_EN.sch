...
<rule abstract="true"
   ...
   <assert role="error"
           ...
           see="https://art-decor.org/mediawiki/index.php?title=DTr1_EN">dtr1-5-EN: [RIM-001] 
...
<value-of select="$name"/> elements which are not null</assert>
   <assert role="error"
           ...
           see="https://art-decor.org/mediawiki/index.php?title=DTr1_EN">dtr1-6-EN: [RIM-002] 
