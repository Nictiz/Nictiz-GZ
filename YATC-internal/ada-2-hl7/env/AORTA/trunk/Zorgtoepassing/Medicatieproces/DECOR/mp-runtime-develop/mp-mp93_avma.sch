...
<schema queryBinding="xslt2"
   ...
   <title>Schematron file for transaction Sturen antwoord voorstel medicatieafspraak MP9 3.0.0 (2.16.840.1.113883.2.4.3.11.60.20.77.4.446 2022-06-30T00:00:00)</title>
   ...
   <!-- Include the project schematrons related to scenario mp93_avma -->
   <!-- MPBaseAntwVoorstelMA -->
   <pattern>
      <title>MPBaseAntwVoorstelMA</title>
      <rule fpi="RUL-EXPEL"
            context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9395']] | descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9399']]"
                 see="http://decor.nictiz.nl/pub/medicatieproces/mp-html-develop/tmp-2.16.840.1.113883.2.4.3.11.60.20.77.10.9400-2022-03-15T150730.html">(MPBaseAntwVoorstelMA): In de instance werd tenminste één van de volgende elementen verwacht: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9395']] | descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9399']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9400-2022-03-15T150730.sch"/>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9400-2022-03-15T150730-closed.sch"/>
   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9400-2022-03-15T150730"/>
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9396-2022-03-15T000000"/>
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9397-2022-03-15T000000"/>
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9398-2022-03-15T000000"/>
   </phase>
   <phase id="MPBaseAntwVoorstelMA">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9400-2022-03-15T150730"/>
   </phase>
   <phase id="MPBaseAntwVoorstelMA-closed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9400-2022-03-15T150730-closed"/>
   </phase>
   <phase id="MPCDAAntwVMA">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9396-2022-03-15T000000"/>
   </phase>
   <phase id="OBSAntwVMA">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9397-2022-03-15T000000"/>
   </phase>
   <phase id="MPVMAIdentificatie">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9398-2022-03-15T000000"/>
   </phase>
   <!-- Include schematrons from templates with explicit * or ** context (but no representing templates), only those used in scenario template -->
   <!-- MPCDAAntwVMA -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9396-2022-03-15T000000.sch"/>
   <!-- OBSAntwVMA -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9397-2022-03-15T000000.sch"/>
   <!-- MPVMAIdentificatie -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9398-2022-03-15T000000.sch"/>
</schema>