...
<schema queryBinding="xslt2"
   ...
   <title>Schematron file for transaction Beschikbaarstellen wisselend doseerschema MP9 3.0.0 (2.16.840.1.113883.2.4.3.11.60.20.77.4.387 2022-06-30T00:00:00)</title>
   ...
   <!-- Include the project schematrons related to scenario mp93_mg_wds -->
   <!-- MPHL7WisselendDoseerschemaOrganizer2 -->
   <pattern>
      <title>MPHL7WisselendDoseerschemaOrganizer2</title>
      <rule fpi="RUL-EXPEL"
            context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9413']]"
                 see="http://decor.nictiz.nl/pub/medicatieproces/mp-html-develop/tmp-2.16.840.1.113883.2.4.3.11.60.20.77.10.9413-2022-11-18T132644.html">(MPHL7WisselendDoseerschemaOrganizer2): In de instance werd het volgende element verwacht: descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9413']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9413-2022-11-18T132644.sch"/>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9413-2022-11-18T132644-closed.sch"/>
   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9413-2022-11-18T132644"/>
   ...
   <phase id="MPHL7WisselendDoseerschemaOrganizer2">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9413-2022-11-18T132644"/>
   </phase>
   <phase id="MPHL7WisselendDoseerschemaOrganizer2-closed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9413-2022-11-18T132644-closed"/>
   </phase>
