...
<xsl:stylesheet version="2.0" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:local="#local.2024011810474778717440100" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <!-- ================================================================== -->
    <!--
        TBD
    -->
        ...
        <xsl:for-each select="$transmission_wrapper">
            ...
            <xsl:element name="{./root_xml_element/@value}">
                ...
                <xsl:for-each select="./interaction_id">
                    <interactionId root="{$oidHL7InteractionID}" extension="{@value}"/>
                </xsl:for-each>
                        ...
                        <subject typeCode="SUBJ" contextConductionInd="false">
                            <xsl:for-each select="./registration_wrapper">
                                <registrationProcess classCode="REG" moodCode="EVN">
                                    ...
                                    <xsl:call-template name="Kernset22_withInputDoc">
