...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:local="#local.2024011810474787587220100" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <!-- ================================================================== -->
    <!--
        TBD
    -->
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.90.900171_20111206000000">
        ...
        <xsl:call-template name="question_observation">
            ...
            <xsl:with-param name="observation_codeSystem" select="$oidSNOMEDCT"/>
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.90.900186_20111206000000">
        ...
        <observation classCode="OBS" moodCode="EVN">
            ...
            <value value="false">
                <xsl:attribute name="xsi:type" select="'BL'"/>
            </value>
        </observation>
    </xsl:template>
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.90.900231_20140611000000">
        <xsl:for-each select="direct_ipd_gewenstq | direct_ipd_gewenstq">
            <act classCode="CONS" moodCode="INT">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.90.900910_20130320000000">
        ...
        <observation classCode="OBS" moodCode="EVN">
            ...
            <value representation="B64" mediaType="application/pdf">
                <xsl:attribute name="xsi:type" select="'ED'"/>
                <xsl:value-of select="./@value"/>
            </value>
        </observation>
    </xsl:template>
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.90.901045_20161201143523">
        <!-- context verwijzing_naar -->
        <xsl:for-each select="zorginstelling[.//(@value | @code | @nullFlavor)]">
            <assignedEntity classCode="ASSIGNED">
                ...
                <xsl:for-each select=".[zorgaanbieder_identificatie_nummer[@value | @nullFlavor]]">
                    <representedOrganization classCode="ORG" determinerCode="INSTANCE">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.90.900993_20161206101240">
        <xsl:param name="parentElementName" select="'pertinentInformation3'"/>
        <xsl:call-template name="question_observation">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.90.900995_20161206134416">
        ...
        <procedure classCode="PROC" moodCode="EVN">
            ...
            <xsl:call-template name="makeNegationAttr">
                <xsl:with-param name="inputValue" select="../pijnbestrijdingq/@value"/>
            </xsl:call-template>
            <templateId root="2.16.840.1.113883.2.4.6.10.90.900995"/>
            <id nullFlavor="NI"/>
            <code code="278414003" codeSystem="{$oidSNOMEDCT}" codeSystemName="{$oidMap[@oid=$oidSNOMEDCT]/@displayName}" displayName="Pijnbestrijding"/>
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.90.901098_20180221154619">
        <act classCode="ACT" moodCode="EVN">
            ...
            <xsl:for-each select="verwijzing_naar[.//(@code | @value | @nullFlavor)]">
                <performer typeCode="PRF">
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.90.901045_20161201143523"/>
                </performer>
            </xsl:for-each>
            <xsl:for-each select="verwijzing_van[.//(@code | @value | @nullFlavor)]">
                <author typeCode="AUT">
                    <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.90.901045_20161201143523"/>
                </author>
            </xsl:for-each>
            <xsl:for-each select="redenen_van_verwijzing[.//(@code | @value | @nullFlavor)]">
                <xsl:for-each select="van_1e_naar_2e_lijn[.//(@code | @value | @nullFlavor)]">
                    <xsl:for-each select="                             ./algemene_anamnese[.//(@code | @value | @nullFlavor)]                             | ./obstetrische_anamnese[.//(@code | @value | @nullFlavor)]                             | ./zwangerschap[.//(@code | @value | @nullFlavor)]                             | ./einde_zwangerschap[.//(@code | @value | @nullFlavor)]                             | ./bevalling[.//(@code | @value | @nullFlavor)]                             | ./postnatale_fase[.//(@code | @value | @nullFlavor)]                             | ./overig[.//(@code | @value | @nullFlavor)]">
                        <outboundRelationship typeCode="RSON">
                            <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.90.901097_20180221154011"/>
                        </outboundRelationship>
                    </xsl:for-each>
                </xsl:for-each>
                <xsl:for-each select="                         van_2e_naar_3e_lijn[.//(@code | @value | @nullFlavor)]                         | van_2e_naar_1e_lijn[.//(@code | @value | @nullFlavor)]                         | van_3e_naar_2e_lijn[.//(@code | @value | @nullFlavor)]">
                    <outboundRelationship typeCode="RSON">
                        <xsl:call-template name="template_2.16.840.1.113883.2.4.6.10.90.901097_20180221154011"/>
                    </outboundRelationship>
                </xsl:for-each>
