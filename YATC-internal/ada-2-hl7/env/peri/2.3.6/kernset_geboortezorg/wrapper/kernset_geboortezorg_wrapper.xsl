...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:local="#local.2024011810474774431610100" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <!-- ================================================================== -->
    <!--
        TBD
    -->
    ...
    <xsl:import href="../payload/REPC_EX004014NL_Kernset_2.3.6.xsl"/>
    ...
    <xsl:variable name="input_xml_payload_doc" select="if ($input_xml_payload instance of xs:string) then document($input_xml_payload) else $input_xml_payload"/>
    <xsl:param name="input_xml_wrapper_doc" select="if ($input_xml_wrapper instance of xs:string) then document($input_xml_wrapper) else $input_xml_wrapper"/>
    
    <xsl:param name="testSchematron" as="xs:boolean" select="true()"/>

    <xsl:param name="dateT" as="xs:date?" select="xs:date('2022-01-01')"/>
