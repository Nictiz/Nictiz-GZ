...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:uuid="http://www.uuid.org" xmlns:local="#local.2024011509165894202460100" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <!-- ================================================================== -->
    <!--
        TBD
    -->
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.121.10.33_20210701000000" match="zorgaanbieder" mode="handleZorgaanbiederReprOrg">
        <!-- Template for zorgaanbieder in representedOrganization -->
        <xsl:param name="in" as="element()?" select=".">
            <!-- The input ada element for zorgaanbieder, defaults to context -->
        </xsl:param>
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.66.10.9032_20141113000000" match="zorgaanbieder" mode="handleZorgaanbiederCDADossierhouder">
        <!-- Organizer custodian template for zorgaanbieder in participant Level 3. If there is any ward data (afdeling) then ParticipantRole and PlayingEntity are the ward/afdeling scoped by the organization, otherwise the organisation is ParticipantRole and PlayingEntity -->
        <xsl:param name="in" as="element()?" select=".">
            <!-- The input ada element for zorgaanbieder, defaults to context -->
        </xsl:param>
    ...
    <xsl:template name="template_1.3.6.1.4.1.19376.1.3.3.1.7_20080808000000" match="zorgaanbieder" mode="handleZorgaanbiederCDAPerformer">
        <!-- Organizer performer template from IHE XDLAB for zorgaanbieder in participant Level 3. If there is any ward data (afdeling) then ParticipantRole and PlayingEntity are the ward/afdeling scoped by the organization, otherwise the organisation is ParticipantRole and PlayingEntity -->
        <xsl:param name="in" as="element()?" select=".">
            <!-- The input ada element for zorgaanbieder, defaults to context -->
        </xsl:param>
