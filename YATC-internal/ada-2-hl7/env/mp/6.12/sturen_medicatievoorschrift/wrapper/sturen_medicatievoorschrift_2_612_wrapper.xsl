...
<xsl:stylesheet version="2.0" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:local="#local.2024011810474696534670100" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <!-- ================================================================== -->
    <!--
        TBD
    -->
        ...
        <xsl:for-each select="$transmission_wrapper">
            ...
            <xsl:element name="{./root_xml_element/@value}">
                ...
                <xsl:for-each select="./interaction_id">
                    <interactionId extension="{./@value}" root="{$oidHL7InteractionID}"/>
                </xsl:for-each>
                ...
                <xsl:for-each select="./attention_line_bsn">
                    <attentionLine>
                        ...
                        <value extension="{./@value}" root="{$oidBurgerservicenummer}">
                            <xsl:attribute name="xsi:type" select="'II'"/>
                        </value>
                    </attentionLine>
                </xsl:for-each>
