...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://hl7.org/fhir" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:uuid="http://www.uuid.org" xmlns:local="urn:fhir:stu3:functions" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    ...
    <xsl:template name="laboratoryResultObservationReference" match="//laboratorium_test[not(laboratorium_test)][not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)] | //laboratory_test[not(laboratory_test)][not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)]" mode="doLaboratoryResultObservationReference-2.1" as="element()+">
    ...
    <!-- Match expression was not XSLT2 compliant. Changed to: -->
    <xsl:template name="laboratoryResultObservationEntry" match="//laboratorium_test[not(laboratorium_test)][not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)] | //laboratory_test[not(laboratory_test)][not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)]" mode="doLaboratoryResultObservationEntry-2.1" as="element(f:entry)">
    ...
    <xsl:template name="zib-LaboratoryTestResult-PanelObservation-2.1" match="//laboratorium_uitslag[not(laboratorium_uitslag)][not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)] | //laboratory_test_result[not(laboratory_test_result)][not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)]" as="element(f:Observation)" mode="doZibLaboratoryTestResultPanelObservation-2.1">
        ...
        <xsl:param name="in" select="." as="element()?">
            <!-- Node to consider in the creation of the Observation resource for LaboratoryTestResult. -->
        </xsl:param>
                ...
                <Observation>
                    ...
                    <xsl:for-each select="laboratorium_test | laboratory_test">
                        <related>
                            ...
                            <target>
                                <xsl:apply-templates select="." mode="doLaboratoryResultObservationReference-2.1"/>
                            </target>
                        </related>
                    </xsl:for-each>
    ...
    <xsl:template name="zib-LaboratoryTestResult-Observation-2.1" match="//laboratorium_test[not(laboratorium_test)][not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)] | //laboratory_test[not(laboratory_test)][not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)]" as="element(f:Observation)" mode="doZibLaboratoryTestResultObservation-2.1">
        ...
        <xsl:param name="in" select="." as="element()?">
            <!-- Node to consider in the creation of the Observation resource for LaboratoryTest. -->
        </xsl:param>
        <xsl:param name="logicalId" as="xs:string?">
            <!-- Optional FHIR logical id for the record. -->
        </xsl:param>
