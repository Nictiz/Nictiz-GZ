...
<xsl:stylesheet version="2.0" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:local="#local.2023100511155221632860200">
    <!-- ================================================================== -->
    <!--
        This XSL was created to facilitate mapping from ADA BundleOfContactReport-transaction, 
        to HL7 FHIR STU3 profiles http://nictiz.nl/fhir/StructureDefinition/gp-EncounterReport.
    -->
    <!-- ================================================================== -->
    <!--
        Copyright © Nictiz
    ...
    <xsl:param name="matchResource" select="('Encounter')" as="xs:string*"/>

    <xsl:variable name="usecase">encounter</xsl:variable>
    ...
    <xsl:template match="/">
        <!-- Start conversion. Handle interaction specific stuff for "beschikbaarstellen encounters". -->
        <xsl:call-template name="BundleOfEncounters"/>
    </xsl:template>

    <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->

    <xsl:template name="BundleOfEncounters">
