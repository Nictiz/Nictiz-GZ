...
<xsl:stylesheet version="3.0" exclude-result-prefixes="#all" expand-text="false" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:local="#local.2023032108485609652440100" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    ...
    <xsl:template match="sturen_medicatieoverzicht" mode="copy-for-resolve">
        ...
        <adaxml>
            ...
            <data>
                <beschikbaarstellen_medicatieoverzicht app="mp-mp920" shortName="beschikbaarstellen_medicatieoverzicht" formName="medicatieoverzicht" transactionRef="2.16.840.1.113883.2.4.3.11.60.20.77.4.191" transactionEffectiveDate="2021-04-14T15:39:26" prefix="mp-" language="nl-NL" title="{@title}" desc="{@desc}" id="{concat($concat2id,@id)}">
        ...
        <xsl:if test="following-sibling::medicamenteuze_behandeling">
            ...
            <xsl:variable name="mbhs" as="element()?">
                <mbhs>
                    ...
                    <xsl:for-each select="following-sibling::*/toedieningsafspraak">
                        ...
                        <medicamenteuze_behandeling conceptId="2.16.840.1.113883.2.4.3.11.60.20.77.2.4.41">
                            ...
                            <xsl:comment>Administration agreement (toedieningsafspraak) with id <xsl:value-of select="$ta-id"/> found in instance with id: <xsl:value-of select="$resolved-ta/ancestor::data/*/@id"/> and title: id: <xsl:value-of select="$resolved-ta/ancestor::data/*/@title"/></xsl:comment>
    ...
    <xsl:template match="medicamenteuze_behandeling[@conceptId = '2.16.840.1.113883.2.4.3.11.999.77.2.4.41.1'] | patient-afko" mode="copy-for-resolve"><!-- 
