...
=Addenda voor inhoudelijke gegevens=</xsl:text>
    ...
    <xsl:template match="naamgegevens[naamgegevens] | adresgegevens[adresgegevens] | contactgegevens[contactgegevens]" mode="maak-tabel-rij">
        <!-- Template to get rid of double nested stuff which unfortunately ended up in dataset -->
