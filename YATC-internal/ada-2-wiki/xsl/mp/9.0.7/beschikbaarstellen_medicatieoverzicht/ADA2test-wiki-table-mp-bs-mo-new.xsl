...
{{DISPLAYTITLE:Beschikbaarstellen medicatieoverzicht 9.0.7 - MA: addendum inhoudelijke gegevens kwalificatie}}
        ...
        <xsl:choose>
            <xsl:when test="$do-ada-files">
                ...
                <xsl:call-template name="yatcs:write-debug-document">
                    ...
                    <xsl:with-param name="filename" select="'overview.xml'"/>
