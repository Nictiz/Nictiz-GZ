...
rem Script for running the compare-ada-2-wiki pipeline from the command line.
rem See ../xpl/help/compare-ada-2-wiki.help.txt for more information.
...
set CWSCRIPT=%BASEDIR%../xpl/compare-ada-2-wiki.xpl
