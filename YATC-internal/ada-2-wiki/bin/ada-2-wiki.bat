...
rem Script for running the ada-2-wiki-cw pipeline from the command line.
rem See ../xpl/help/ada-2-wiki-cw.help.txt for more information.
...
set CWSCRIPT=%BASEDIR%../xpl/ada-2-wiki-cw.xpl
