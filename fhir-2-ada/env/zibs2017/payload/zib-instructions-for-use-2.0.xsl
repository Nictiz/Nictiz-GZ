...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:local="urn:fhir:stu3:functions">
    ...
    <xsl:template match="f:text" mode="zib-instructions-for-use-2.0">
        <!-- Template to convert f:text to omschrijving -->
        <omschrijving>
    ...
    <xsl:template match="f:doseQuantity" mode="zib-instructions-for-use-2.0">
        <!-- Template to convert f:doseQuantity to aantal (with vaste_waarde child) and eenheid elements. -->
    ...
    <xsl:template match="f:asNeededCodeableConcept" mode="zib-instructions-for-use-2.0">
        <!-- Template to convert f:asNeededCodeableConcept to criterium with code and omschrijving children -->
        <criterium>
            <xsl:call-template name="CodeableConcept-to-code"/>
    ...
    <xsl:template match="f:rateRange" mode="zib-instructions-for-use-2.0">
        <!-- Template to convert f:rateRange to waarde (with min and max children), eenheid and tijdseenheid -->
