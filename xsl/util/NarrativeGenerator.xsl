...
-->
<xsl:stylesheet version="2.0" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:local="#local.2024020614533867108350100" xmlns:xhtml="http://www.w3.org/1999/xhtml">
    <!-- ================================================================== -->
    <!--
        TBD
    -->
            ...
            <div xmlns="http://www.w3.org/1999/xhtml">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <xsl:for-each select="f:content/descendant-or-self::*[f:reference | f:identifier | f:display]">
                            <tr>
                                <th>
                                    <xsl:call-template name="util:getLocalizedString">
            ...
            <div xmlns="http://www.w3.org/1999/xhtml">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <xsl:if test="f:indexed">
                            <tr>
                                <th>
                                    <xsl:call-template name="util:getLocalizedString">
                                        <xsl:with-param name="key">Indexed</xsl:with-param>
                                        <xsl:with-param name="textLang" select="$textLang"/>
                                    </xsl:call-template>
                                </th>
                                <td>
                                    <xsl:call-template name="doDT_DateTime">
                                        <xsl:with-param name="in" select="f:indexed"/>
                                        <xsl:with-param name="textLang" select="$textLang"/>
                                    </xsl:call-template>
                                </td>
                            </tr>
            ...
            <div xmlns="http://www.w3.org/1999/xhtml">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <xsl:if test="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-Medication-PeriodOfUse'] |                             f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicationUse-Duration']">
                            <tr>
                                <th>
                                    <xsl:call-template name="util:getLocalizedString">
                                ...
                                <td>
                                    <xsl:variable name="contents" as="element()*">
                                        <xsl:for-each select="                                             f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-Medication-PeriodOfUse'] |                                             f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicationUse-Duration']">
                                            <li>
                                                <xsl:call-template name="doDT">
                                                    <xsl:with-param name="in" select="f:*[starts-with(local-name(), 'value')]"/>
                                                    <xsl:with-param name="textLang" select="$textLang"/>
            ...
            <div xmlns="http://www.w3.org/1999/xhtml">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <xsl:if test="f:basedOn |                                 f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicationAgreement-BasedOnAgreementOrUse'] |                                 f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-DispenseRequest-RelatedMedicationAgreement']">
                            <tr>
                                <th>
                                    <xsl:call-template name="util:getLocalizedString">
                                        <xsl:with-param name="key">Based On</xsl:with-param>
                                ...
                                <td>
                                    <xsl:variable name="contents" as="element()*">
                                        <xsl:for-each select="f:basedOn |                                                  f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicationAgreement-BasedOnAgreementOrUse']/f:*[starts-with(local-name(), 'value')] |                                                 f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-DispenseRequest-RelatedMedicationAgreement']/f:*[starts-with(local-name(), 'value')]">
                                            <li>
                                                <xsl:call-template name="doDT_Reference">
                                                    <xsl:with-param name="in" select="."/>
                                                    <xsl:with-param name="textLang" select="$textLang"/>
                        ...
                        <xsl:if test="f:supportingInformation |                                 f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-Medication-AdditionalInformation']">
                            <tr>
                                <th>
                                    <xsl:call-template name="util:getLocalizedString">
                                        <xsl:with-param name="key">Supporting Information</xsl:with-param>
                        ...
                        <xsl:if test="f:*[starts-with(local-name(), 'reason')] | f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-AdministrationAgreement-AgreementReason']">
                            <tr>
                                ...
                                <td>
                                    <xsl:variable name="contents" as="element()*">
                                        <xsl:for-each select="f:*[starts-with(local-name(), 'reason')] |                                                                f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-AdministrationAgreement-AgreementReason']">
                                            <li>
                                                <xsl:choose>
        ...
        <xsl:for-each select="$in">
            <xsl:variable name="str">
                <xsl:choose>
                    ...
                    <xsl:when test="local-name() = concat($baseName, 'Integer') or local-name() = concat($baseName, 'Count') or local-name() = concat($baseName, 'Decimal')">
                        <xsl:call-template name="doDT_Integer">
                            <xsl:with-param name="in" select="."/>
                            <xsl:with-param name="textLang" select="$textLang"/>
                            <xsl:with-param name="sep" select="$sep"/>
