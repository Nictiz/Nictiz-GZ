...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:local="#local.href.mod.xsl" exclude-result-prefixes="#all">
    <!-- ================================================================== -->
    <!-- 
    ...
    <xsl:variable name="yatcs:protocol-file" as="xs:string" select="'file'">
    ...
    <xsl:function name="yatcs:href-concat" as="xs:string">
        <!--~ 
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:variable name="prefix" as="xs:string" select="yatcs:href-concat(remove($href-path-components, count($href-path-components)))"/>
    ...
    <xsl:function name="yatcs:href-is-absolute" as="xs:boolean">
        <!--~ 
    ...
    <xsl:function name="yatcs:href-name" as="xs:string">
        <!--~ 
    ...
    <xsl:function name="yatcs:href-noext" as="xs:string">
        <!--~ 
    ...
    <xsl:function name="yatcs:href-name-noext" as="xs:string">
        <!--~ 
    ...
    <xsl:function name="yatcs:href-ext" as="xs:string">
        <!--~ 
    ...
    -->
        ...
        <xsl:variable name="name-only" as="xs:string" select="yatcs:href-name($href)"/>
        <xsl:choose>
    ...
    <xsl:function name="yatcs:href-path" as="xs:string">
        <!--~ 
    ...
    <xsl:function name="yatcs:href-result-doc" as="xs:string">
        <!--~ 
    ...
    <xsl:function name="yatcs:href-canonical" as="xs:string">
        <!--~ 
    ...
    -->
        ...
        <xsl:variable name="protocol" as="xs:string" select="yatcs:href-protocol($href)"/>
        <xsl:variable name="href-no-protocol" as="xs:string" select="yatcs:href-protocol-remove($href)"/>
        ...
        <xsl:variable name="href-canonical-filename" as="xs:string" select="concat($href-start-slash, string-join(local:href-canonical-process-components($href-components, 0), '/'))"/>
    ...
    <xsl:function name="local:href-canonical-process-components" as="xs:string*">
        ...
        <xsl:variable name="remainder-components" as="xs:string*" select="subsequence($href-components-unprocessed, 1, count($href-components-unprocessed) - 1)"/>
        ...
        next name-component of the remainders to be removed:-->
            ...
            <xsl:otherwise>
                ...
                <xsl:variable name="component-to-process-2" as="xs:string" select="if (matches($component-to-process, '^[a-z]:$')) then upper-case($component-to-process) else $component-to-process"/>
    ...
    <xsl:function name="yatcs:href-relative" as="xs:string">
        <!--~ 
    ...
    <xsl:function name="yatcs:href-relative-from-path" as="xs:string">
        <!--~
    ...
    -->
        ...
        <xsl:variable name="from-href-path-canonical" as="xs:string" select="yatcs:href-canonical($from-href-path)"/>
        <xsl:variable name="from-protocol" as="xs:string" select="yatcs:href-protocol($from-href-path-canonical, $yatcs:protocol-file)"/>
        <xsl:variable name="from-no-protocol" as="xs:string" select="yatcs:href-protocol-remove($from-href-path-canonical)"/>
        <xsl:variable name="from-components-no-filename" as="xs:string*" select="tokenize($from-no-protocol, '/')[. ne '']"/>

        <xsl:variable name="to-href-canonical" as="xs:string" select="yatcs:href-canonical($to-href)"/>
        <xsl:variable name="to-protocol" as="xs:string" select="yatcs:href-protocol($to-href-canonical, $yatcs:protocol-file)"/>
        <xsl:variable name="to-no-protocol" as="xs:string" select="yatcs:href-protocol-remove($to-href-canonical)"/>
    ...
    <xsl:variable name="local:protocol-file-special" as="xs:string" select="concat($yatcs:protocol-file, ':/')"/>

    <xsl:function name="yatcs:href-protocol-present" as="xs:boolean">
    ...
    <xsl:function name="yatcs:href-protocol-remove" as="xs:string">
        <!--~ 
    ...
    <xsl:function name="yatcs:href-protocol-add" as="xs:string">
        ...
        <xsl:variable name="ref-1" as="xs:string" select="if ($force) then yatcs:href-protocol-remove($href) else translate($href, '\', '/')"/>
        <xsl:choose>
    ...
    <xsl:function name="yatcs:href-protocol" as="xs:string">
        <!--~ 
    ...
    <xsl:function name="yatcs:href-add-encoding" as="xs:string">
        <!--~ 
    ...
    <xsl:function name="yatcs:href-decode-uri" as="xs:string">
        ...
        <xsl:variable name="result-fragments" as="xs:string*">
            <xsl:analyze-string select="$href" regex="%[a-fA-F0-9]{{2}}">
                <xsl:matching-substring>
                    <xsl:variable name="char-code" as="xs:integer" select="(local:hex-char2int(substring(., 2, 1)) * 16) + local:hex-char2int(substring(., 3, 1))"/>
