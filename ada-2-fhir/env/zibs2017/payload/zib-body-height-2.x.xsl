...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://hl7.org/fhir" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:uuid="http://www.uuid.org" xmlns:local="urn:fhir:stu3:functions" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    ...
    <!--The name of this stylesheet deviates from the naming convention, as it supersedes the stylesheet 'zib-body-height-2.1.xsl' used in package 1.3.10, but the version of the FHIR profile in package 2.x hasn't increased w.r.t. major or minor version number.-->
    ...
    <!-- Match expression was not XSLT2 compliant. Changed to: -->
    <xsl:template name="zib-BodyHeight-2.x" match="lichaamslengte[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)] | body_height[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)]" mode="doZibBodyHeight-2.x">
    ...
    <xsl:function name="nf:get-body-height-display" as="xs:string?">
        ...
        <xsl:for-each select="$adaBodyHeight">
            <xsl:variable name="datum-string" select="                     if ((lengte_datum_tijd | height_date_time)/@value castable as xs:dateTime) then                         format-dateTime((lengte_datum_tijd | height_date_time)/@value, '[D01] [MN,*-3], [Y0001] [H01]:[m01]')                     else                         if ((lengte_datum_tijd | height_date_time)/@value castable as xs:date) then                             format-date((lengte_datum_tijd | height_date_time)/@value, '[D01] [MN,*-3], [Y0001]')                         else                             (lengte_datum_tijd | height_date_time)/@value"/>
