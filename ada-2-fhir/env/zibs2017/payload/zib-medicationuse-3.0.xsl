...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://hl7.org/fhir" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:uuid="http://www.uuid.org" xmlns:local="urn:fhir:stu3:functions" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    ...
    <xsl:template name="MedicationUseEntry-3.0" match="medicatiegebruik[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)] | medication_use[not(@datatype = 'reference')][.//(@value | @code | @nullFlavor)]" as="element()" mode="doMedicationUseEntry-3.0">
        <!-- Template based on FHIR Profile https://simplifier.net/NictizSTU3-Zib2017/ZIB-MedicationUse/ version 3.0  -->
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="stoptype/@code or stoptype[@codeSystem = $oidHL7NullFlavor]">
                            <xsl:call-template name="util:logMessage">
                                ...
                                <xsl:with-param name="msg">An unknown stoptype has been encountered, @code: <xsl:value-of select="stoptype/@code"/>, @codeSystem: <xsl:value-of select="stoptype/@codeSystem"/></xsl:with-param>
