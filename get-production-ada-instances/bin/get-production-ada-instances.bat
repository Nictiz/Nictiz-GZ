...
rem Script for running the get-production-ada-instances pipeline from the command line.
rem See ../xpl/help/get-production-ada-instances-cw.help.txt for more information.
...
set CWSCRIPT=%BASEDIR%../xpl/get-production-ada-instances-cw.xpl
