...
rem Script for starting the processing for this component. 
rem It calls the general engine's process script that, in turn, starts the processing XPath pipeline.
...
%~dp0../../../YATC-shared/general-engine/bin/process.bat "%~dp0%~nx0" %*