...
rem Script for starting the compare processing for this component. 
rem It calls the general engine's compare script that, in turn, starts the processing XPath pipeline.
...
%~dp0../../../YATC-shared/general-engine/bin/compare.bat "%~dp0%~nx0" %*