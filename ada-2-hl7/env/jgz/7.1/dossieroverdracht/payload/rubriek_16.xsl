...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="2.0">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.6.10.100.118">
        ...
        <neonateData xmlns="urn:hl7-org:v3" classCode="CATEGORY" moodCode="EVN">
            ...
            <!-- Item(s) :: scrotale_testes_bij_geboorte-->
            <xsl:for-each select="scrotale_testes_bij_geboorte">
                <component3 typeCode="COMP">
                    <neonateObservations classCode="OBS" moodCode="EVN">
                        <code code="1609" codeSystem="2.16.840.1.113883.2.4.4.40.267">
                            <xsl:copy-of select="$W0639_HL7_W0646_HL7_W0647_HL7/conceptList/concept[@code = '1609'][@codeSystem = '2.16.840.1.113883.2.4.4.40.267']/@displayName"/>
                        </code>
