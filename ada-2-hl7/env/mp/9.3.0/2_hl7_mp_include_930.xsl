...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:local="#local.2024011810474750857820100" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:hl7="urn:hl7-org:v3" xmlns:util="urn:hl7:utilities" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:nf="http://www.nictiz.nl/functions" xmlns:hl7nl="urn:hl7-nl:v3" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:pharm="urn:ihe:pharm:medication">
    <!-- ================================================================== -->
    <!--
        TBD
    -->
                        ...
                        <xsl:for-each select="prik_plak_locatie/anatomische_locatie[(locatie | lateraliteit)[@code]]">
                            <approachSiteCode>
                                ...
                                <xsl:for-each select="(lateraliteit[@code])[1]">
                                    <qualifier>
                                        <name code="272741003" codeSystem="{$oidMap[@oid = $oidSNOMEDCT]/@oid}" codeSystemName="{$oidMap[@oid = $oidSNOMEDCT]/@displayName}" displayName="Lateraliteit"/>
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9442_20221124134142" match="medicatie_gebruik" mode="HandleMGBContents920">
        ...
        <xsl:for-each select="$in">
            ...
            <consumable>
                <xsl:call-template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9363_20210602155855">
                    <xsl:with-param name="product" select="(../../bouwstenen/farmaceutisch_product[@id = current()/gebruiksproduct/farmaceutisch_product/@value])[1]"/>
                </xsl:call-template>
            </consumable>
