...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:local="#local.2024011810474708397190100" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:hl7="urn:hl7-org:v3" xmlns:util="urn:hl7:utilities" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:nf="http://www.nictiz.nl/functions" xmlns:hl7nl="urn:hl7-nl:v3" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:pharm="urn:ihe:pharm:medication">
    <!-- ================================================================== -->
    <!--
        
            Created on: Oct 16, 2018
            Author: nictiz
            Mapping xslt for creating HL7 for Medicatieproces 9.1.x. To be imported or included from another xslt. Only templates for 9.1.x which are not shared by other versions.
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9275_20191121115247" match="medicatieafspraak | medication_agreement">
        <!-- Mapping of medicatieafspraak concept in ADA ('eigen of ongedefinieerde MA') to HL7 CDA template 2.16.840.1.113883.2.4.3.11.60.20.77.10.9275 -->
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9276_20191121115616">
        <!--  Medicatieafspraak inhoud - vanaf MP 9.1 -->
        <xsl:param name="in" select=".">
            <!-- Input ada element -->
        </xsl:param>
        <xsl:for-each select="$in">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9277_20191121123918">
        <!-- Mapping of zib nl.zorg.Medicatieafspraak concept in ADA ('andermans MA') to HL7 CDA template 2.16.840.1.113883.2.4.3.11.60.20.77.10.9277 -->
        <xsl:param name="in" select=".">
            <!-- ADA Node to consider in the creation of the hl7 element -->
        </xsl:param>
        <xsl:for-each select="$in">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9279_20191121141551" match="medicatie_gebruik" mode="HandleMGBContents910">
        <!--  Medicatiegebruik inhoud - vanaf MP 9.1.0 -->
        <xsl:param name="in" select=".">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9287_20191121150123">
        <!--  andermans Medicatiegebruik - vanaf MP 9.1.0  -->
        <xsl:param name="in" select="."/>
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9299_20191125140232" match="toedieningsafspraak" mode="HandleTA910">
        <!-- Toedieningsafspraak vanaf 9.1.0 -->
        <xsl:param name="in" select=".">
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9281_20191121142645" match="medicatie_gebruik | medicatiegebruik" mode="HandleMGB910">
        <!-- Medicatiegebruik - vanaf MP 9.1.0  -->
        <xsl:param name="in" select=".">
            <!-- ada element voor medicatiegebruik -->
        </xsl:param>
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9303_20191125142708">
        <!--  'andermans' Toedieningsafspraak vanaf 9.1.0 -->
        <xsl:param name="ta"/>
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9310_2019128172830" match="toedieningsschema" mode="HandleCDAAdministrationSchedule910">
        <!-- Create an MP CDA administration schedule based on ada toedieningsschema from MP 9.1.x -->
