...
<schema queryBinding="xslt2"
   ...
   <title>Schematron file for transaction Sturen voorstel verstrekkingsverzoek MP9 3.0.0 (2.16.840.1.113883.2.4.3.11.60.20.77.4.401 2022-06-30T00:00:00)</title>
   ...
   <!-- Include the project schematrons related to scenario mp93_vvv -->
   <!-- MPBaseVoorstelVV2 -->
   <pattern>
      <title>MPBaseVoorstelVV2</title>
      <rule fpi="RUL-EXPEL"
            context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9453']] | descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9452']]"
                 see="http://decor.nictiz.nl/pub/medicatieproces/mp-html-develop/tmp-2.16.840.1.113883.2.4.3.11.60.20.77.10.9454-2023-01-06T102633.html">(MPBaseVoorstelVV2): In de instance werd tenminste één van de volgende elementen verwacht: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9453']] | descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9452']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9454-2023-01-06T102633.sch"/>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9454-2023-01-06T102633-closed.sch"/>
   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9454-2023-01-06T102633"/>
      ...
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9451-2023-01-06T095110"/>
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.3.10.0.32-2021-07-01T000000"/>
   </phase>
   <phase id="MPBaseVoorstelVV2">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9454-2023-01-06T102633"/>
   </phase>
   <phase id="MPBaseVoorstelVV2-closed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9454-2023-01-06T102633-closed"/>
   </phase>
   ...
   <!-- MPCDAVoorstelVV2 -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9451-2023-01-06T095110.sch"/>
   <!-- toelichting -->
