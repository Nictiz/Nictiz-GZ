...
<schema queryBinding="xslt2"
   ...
   <title>Schematron file for transaction Sturen antwoord voorstel verstrekkingsverzoek MP9 2.0.0 (2.16.840.1.113883.2.4.3.11.60.20.77.4.331 2022-02-07T00:00:00)</title>
   ...
   <!-- Include the project schematrons related to scenario mp92_avvv -->
   <!-- MPBaseAntwVoorstelVV -->
   <pattern>
      <title>MPBaseAntwVoorstelVV</title>
      <rule fpi="RUL-EXPEL"
            context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9215']] | descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9211']]"
                 see="http://decor.nictiz.nl/pub/medicatieproces/mp-html-20220402T205710/tmp-2.16.840.1.113883.2.4.3.11.60.20.77.10.9210-2018-04-20T174308.html">(MPBaseAntwVoorstelVV): In de instance werd tenminste één van de volgende elementen verwacht: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9215']] | descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9211']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9210-2018-04-20T174308.sch"/>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9210-2018-04-20T174308-closed.sch"/>
   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9210-2018-04-20T174308"/>
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9212-2018-04-20T174745"/>
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9213-2018-04-20T181642"/>
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9214-2018-04-23T130606"/>
   </phase>
   <phase id="MPBaseAntwVoorstelVV">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9210-2018-04-20T174308"/>
   </phase>
   <phase id="MPBaseAntwVoorstelVV-closed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9210-2018-04-20T174308-closed"/>
   </phase>
   <phase id="MPCDAAntwVVV">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9212-2018-04-20T174745"/>
   </phase>
   <phase id="OBSAntwVVV">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9213-2018-04-20T181642"/>
   </phase>
   <phase id="MPVVVIdentificatie">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9214-2018-04-23T130606"/>
   </phase>
   <!-- Include schematrons from templates with explicit * or ** context (but no representing templates), only those used in scenario template -->
   <!-- MPCDAAntwVVV -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9212-2018-04-20T174745.sch"/>
   <!-- OBSAntwVVV -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9213-2018-04-20T181642.sch"/>
   <!-- MPVVVIdentificatie -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9214-2018-04-23T130606.sch"/>
</schema>