...
<schema queryBinding="xslt2"
   ...
   <title>Schematron file for transaction Beschikbaarstellen medicatiegegevens MP9 2.0.0 (2.16.840.1.113883.2.4.3.11.60.20.77.4.301 2022-02-07T00:00:00)</title>
   ...
   <!-- Include the project schematrons related to scenario mp92_mgb -->
   <!-- MPBaseMedicatiegegevens6 -->
   <pattern>
      <title>MPBaseMedicatiegegevens6</title>
      <rule fpi="RUL-EXPEL"
            context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9338']] | descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9341']]"
                 see="http://decor.nictiz.nl/pub/medicatieproces/mp-html-20220402T205710/tmp-2.16.840.1.113883.2.4.3.11.60.20.77.10.9336-2020-10-15T140543.html">(MPBaseMedicatiegegevens6): In de instance werd tenminste één van de volgende elementen verwacht: descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9338']] | descendant-or-self::hl7:organizer[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9341']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9336-2020-10-15T140543.sch"/>
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9336-2020-10-15T140543-closed.sch"/>
   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9336-2020-10-15T140543"/>
      ...
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9356-2021-04-02T132627"/>
      ...
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9373-2021-06-16T162231"/>
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9375-2021-06-16T173557"/>
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9376-2021-06-17T000000"/>
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9380-2021-06-17T175854"/>
      ...
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9404-2022-03-15T000000"/>
   ...
   <phase id="MPBaseMedicatiegegevens6">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9336-2020-10-15T140543"/>
   </phase>
   <phase id="MPBaseMedicatiegegevens6-closed">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9336-2020-10-15T140543-closed"/>
   </phase>
   ...
   <phase id="MPCDAVerstrekkingsverzoek5">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9356-2021-04-02T132627"/>
   </phase>
   ...
   <phase id="MPCDAMedicatietoediening">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9373-2021-06-16T162231"/>
   </phase>
   ...
   <phase id="MPCDAWisselendDoseerSchema">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9380-2021-06-17T175854"/>
   </phase>
   ...
   <phase id="RedenWijzStaAfspraakWDS">
      <active pattern="template-2.16.840.1.113883.2.4.3.11.60.20.77.10.9404-2022-03-15T000000"/>
   </phase>
   ...
   <!-- MPCDAVerstrekkingsverzoek5 -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9356-2021-04-02T132627.sch"/>
   ...
   <!-- MPCDAMedicatietoediening -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9373-2021-06-16T162231.sch"/>
   <!-- RedenAfwijken -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9375-2021-06-16T173557.sch"/>
   <!-- MPAgreed -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9376-2021-06-17T000000.sch"/>
   <!-- MPCDAWisselendDoseerSchema -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9380-2021-06-17T175854.sch"/>
   <!-- MPWDSIdentificatie -->
   ...
   <!-- RedenWijzStaAfspraakWDS -->
   <include href="include/2.16.840.1.113883.2.4.3.11.60.20.77.10.9404-2022-03-15T000000.sch"/>
   <!-- toelichting -->
