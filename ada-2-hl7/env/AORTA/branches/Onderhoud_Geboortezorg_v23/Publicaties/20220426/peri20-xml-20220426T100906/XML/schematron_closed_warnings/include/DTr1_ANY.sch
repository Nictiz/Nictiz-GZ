...
<rule abstract="true"
   ...
   <assert role="error"
        ...
        (@codeSystem, &lt;originalText&gt; or &lt;translation&gt; may have a value), or nullFlavor 'UNC' (@extension or &lt;originalText&gt; may have a value). Found: &lt;
<value-of select="name()"/>
      <value-of select="for $att in (@* except @nullFlavor) return concat(' ', name($att), '=&#34;', $att, '&#34;')"/>&gt;
<value-of select="for $elm in * return concat('&lt;', name($elm), '... /&gt;')"/>&lt;/
