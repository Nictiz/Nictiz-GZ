...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:uuid="http://www.uuid.org" xmlns:local="#local.20240115091657205840100" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <!-- ================================================================== -->
    <!--
        TBD
    -->
    ...
    <xsl:template match="hl7:organizer[not(ancestor::hl7:organizer)]" mode="organizer2CDA">
        ...
        <ClinicalDocument>
            <xsl:attribute name="xsi:schemaLocation" select="'urn:hl7-org:v3 ../hl7_schemas/CDANL_extended.xsd'"/>
                                                ...
                                                <tbody>
                                                    ...
                                                    <xsl:for-each select=".//hl7:observation[hl7:templateId[@root = '2.16.840.1.113883.2.4.3.11.60.7.10.31']]">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <xsl:variable name="result" select="(hl7:interpretationCode/descendant-or-self::*[@codeSystem = '2.16.840.1.113883.6.96'], hl7:interpretationCode/descendant-or-self::*[@codeSystem = '2.16.840.1.113883.5.83'], hl7:interpretationCode)[1]"/>
                                                                <xsl:choose>
                                                                    <xsl:when test="$abnormal">
                                                                        <content styleCode="Bold">
                                                                            <xsl:value-of select="($result/@displayName, $result/@code, $result/hl7:originalText)[1]"/>
                                                                        </content>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <xsl:value-of select="($result/@displayName, $result/@code, $result/hl7:originalText)[1]"/>
    ...
    <xsl:template match="hl7:organizer[not(ancestor::hl7:organizer)]/hl7:templateId | hl7:organizer[not(ancestor::hl7:organizer)]/hl7:code | hl7:organizer[not(ancestor::hl7:organizer)]/hl7:statusCode | hl7:organizer[not(ancestor::hl7:organizer)]/hl7:author" mode="organizer2CDA"><!--  Niet kopiëren  --></xsl:template>
