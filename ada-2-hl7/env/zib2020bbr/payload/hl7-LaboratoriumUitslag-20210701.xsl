...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:uuid="http://www.uuid.org" xmlns:local="urn:fhir:stu3:functions" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <!-- ================================================================== -->
    <!--
        TBD
    -->
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.66.10.77_20220330000000" match="laboratorium_uitslag | laboratory_result" mode="HandleLaboratoryResult">
        <!-- Mapping of zib nl.zorg.LaboratoriumUitslag 4.6 concept in ADA to HL7 Organizer template =======TODO======== -->
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.7.10.31_20220330000000" match="laboratorium_test" mode="HandleLaboratoryResultTest">
        <!-- Mapping of zib nl.zorg.LaboratoriumUitslag 4.6 LaboratoryTest in ADA to HL7 Observation template. Niet ondersteund: NL-CM:13.1.30 InterpretatieMethode -->
        <xsl:param name="in" as="element()?" select=".">
            <!-- ADA Node to consider in the creation of the hl7 element -->
        </xsl:param>
    ...
    <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.7.10.3_20171016000000" match="monster" mode="HandleLaboratoryResultSpecimen">
        <!-- Mapping of zib nl.zorg.LaboratoriumUitslag 4.6 concept in ADA to HL7 Organizer template -->
        <xsl:param name="in" as="element()?" select=".">
            <!-- ADA Node to consider in the creation of the hl7 element -->
        </xsl:param>
    ...
    <xsl:template name="template_1.3.6.1.4.1.19376.1.5.3.1.4.2_20131220000000">
        <!-- IHE Comment Entry – (repository: IHE-PCC-) -->
        <act classCode="ACT" moodCode="EVN">
