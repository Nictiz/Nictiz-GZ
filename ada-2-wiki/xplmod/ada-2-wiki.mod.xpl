...
<p:library xmlns:p="http://www.w3.org/ns/xproc" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:yatci="https://nictiz.nl/ns/YATC-internal" xmlns:local="#local.mp5_xfy_2wb" version="3.0" exclude-inline-prefixes="#all">
    <!-- ================================================================== -->
    <!-- 
       XProc module with generic code for use in the ada-2-wiki component of YATC-internal.
    -->
    <!-- ======================================================================= -->
    <!--
    Copyright © Nictiz
    ...
    <p:declare-step type="yatci:get-ada-2-wiki-data">
        <!-- 
            This step retrieves the ada-2-wiki data and returns this on its result port as an XML document.
            ...
            already loaded document in the $ada2WikiData parameter. If provided, this document will be passed 
        ...
        <yatcs:get-application-data>
            ...
            <p:with-option name="retrievedData" select="$ada2WikiData"/>
            <p:with-option name="parnameDataDocument" select="$yatci:parnameAda2wikiDataDocument"/>
            <p:with-option name="hrefSchema" select="resolve-uri('../xsd/ada-2-wiki-data.xsd', static-base-uri())"/>
            <p:with-option name="hrefSchematron" select="resolve-uri('../sch/ada-2-wiki-data.sch', static-base-uri())"/>
            <p:with-option name="hrefFinalizationStylesheet" select="resolve-uri('xsl-ada-2-wiki.mod/finalize-ada-2-wiki-data.xsl', static-base-uri())"/>
