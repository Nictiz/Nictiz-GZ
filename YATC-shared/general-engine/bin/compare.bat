...
rem Script that starts the compare processing of the general engine.
...
rem Example call: 
rem     %~dp0../../../YATC-shared/general-engine/bin/compare.bat %0 %*
...
set CWSCRIPT=%BASEDIR%../xpl/compare.xpl
