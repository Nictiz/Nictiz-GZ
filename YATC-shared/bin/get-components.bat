...
rem This script runs ../xpl/yatc-get-components.xpl, showing all available YATC components.
...
"%TOOLSBINDIR%/morgana.bat" "%BASEDIR%../xpl/yatc-get-components.xpl"
exit /B

:HELP
echo Returns a list of all available YATC components.
echo Usage: %~n0
exit /B