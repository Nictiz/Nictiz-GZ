...
rem This script returns the parameters XML as computed by the yatcs:get-combined-parameters() function
...
"%TOOLSBINDIR%/saxon.bat" "-s:%BASEDIR%/../data/dummy.xml" "-xsl:%BASEDIR%/../xsl/get-parameters-xml.xsl" "staticBaseUri=%CD%"
exit /B
