...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:hl7="urn:hl7-org:v3" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:hl7nl="urn:hl7-nl:v3" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:uuid="java.util.UUID" xmlns:local="urn:fhir:stu3:functions" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <!-- ================================================================== -->
    <!--
        This XSL was created to facilitate mapping HL7 V3 QUPC_IN990002NL as specified on the Dutch national LSP 
        version 6.10.1.3, to a bundle of HL7 FHIR STU3 instances. The HL7 V3 interaction, for prescriptions contains both 
        logistical information and therapeutic information. The HL7 FHIR profile targets therapeutic information only.
    -->
    <!-- ================================================================== -->
    <!--
        Copyright © Nictiz
    ...
    <xsl:template match="hl7:QUPC_IN990002NL">
        <!-- Handle HL7 V3 Response General Practitioner Professional Summary. Build a FHIR Bundle of type collection unless we are in a V3 Batch Response (MCCI_IN200101), then we assume that part was covered already -->
        <xsl:choose>
            ...
            <xsl:otherwise>
                ...
                <Bundle xmlns="http://hl7.org/fhir">
                    <xsl:attribute name="xsi:schemaLocation" select="'http://hl7.org/fhir http://hl7.org/fhir/STU3/fhir-all.xsd'"/>
    ...
    <xsl:template match="hl7:ControlActProcess/hl7:subject">
        <!-- Handle ControlActProcess/subject -->
    ...
    <xsl:template match="hl7:ControlActProcess/hl7:subject/hl7:PrimaryCareProvision" as="element()*">
        <!-- Handle ControlActProcess/subject/PrimaryCareProvision -->
    ...
    <xsl:template match="*[hl7:id[@root = $oidUZIPersons]]" mode="doPractitionerRole" as="element(f:entry)*">
        <!-- Get Practitioner and PractitionerRole (Zorgverlener) -->
    ...
    <xsl:template match="*[hl7:id[@root = $oidURAOrganizations]]" mode="doOrganization" as="element(f:entry)*">
        <!-- Get Organization (Zorgaanbieder) -->
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <xsl:value-of select="$nameOrganization"/>
                                        </td>
                                    </tr>
                                    <!--<tr>
                                        <th>Contact</th>
    ...
    <xsl:template match="hl7:episodeOfCondition" mode="episode" as="element(f:entry)*">
        <!-- Get EpisodeOfCare and Flags (attentiewaarden) -->
                        ...
                        <div xmlns="http://www.w3.org/1999/xhtml">
                            <table>
                                <tr>
                                    <th>Tekst</th>
                                    <td>
                                        <xsl:value-of select="hl7:text/normalize-space()"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Code</th>
                                    <td>
                                        <xsl:value-of select="hl7:value/string-join(@code | @displayName | hl7:originalText, ' - ')"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <xsl:value-of select="$episodeofCare/hl7:text/normalize-space()"/>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <xsl:value-of select="hl7:code/string-join(@displayName | hl7:originalText, ' - ')"/>
                                        </td>
                                        <!--<td></td>
                                            <td></td>-->
                                        <td>
    ...
    <xsl:template match="hl7:encounter" mode="encounterreport" as="element(f:entry)*">
        <!-- Get Encounter (contactmomenten) and Composition (contactverslagen) -->
        <xsl:param name="patient" as="element()"/>
            ...
            <resource>
                <Encounter>
                        ...
                        <div xmlns="http://www.w3.org/1999/xhtml">
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <xsl:value-of select="string-join((hl7:code/@code, hl7:code/@displayName), ' - ')"/>
                                        </td>
                                        <td>
                                            <xsl:value-of select="hl7:effectiveTime/hl7:low/@value"/>
                                        </td>
                                        <td>
                                            <xsl:for-each select="hl7:*/hl7:ObservationDx/hl7:code">
                                                <div>
                                                    <xsl:value-of select="string-join(string-join((@code, @displayName), ' - '), ' / ')"/>
                                                </div>
                                            </xsl:for-each>
                                        </td>
                                        <td>
                    ...
                    <xsl:if test="$custodianOrganization">
                        <serviceProvider>
                            <xsl:copy-of select="$custodianOrganization[1]/*"/>
                        </serviceProvider>
                    </xsl:if>
                </Encounter>
            </resource>
        ...
        <xsl:for-each-group select="hl7:component[hl7:JournalEntry[hl7:code/@code = ('E', 'P')]]" group-by="hl7:sequenceNumber/@value">
            ...
            <entry xmlns="http://hl7.org/fhir">
                ...
                <resource>
                    <Composition>
                        <xsl:attribute name="xsi:schemaLocation" select="'http://hl7.org/fhir http://hl7.org/fhir/STU3/composition.xsd'"/>
                        <meta>
    ...
    <xsl:template match="hl7:Prescription" mode="medication" as="element(f:entry)*">
        <!-- Get MedicationRequest (voorschrift 6.12) -->
        <xsl:param name="patient" as="element()"/>
    ...
    <xsl:template match="hl7:observation[not(hl7:code/@codeSystem = '2.16.840.1.113883.6.1')]" mode="results" as="element(f:entry)*">
        <!-- Get Observation (metingen / gp-DiagnosticResult) -->
        <xsl:param name="patient" as="element()"/>
        <xsl:variable name="idObservation" select="local:getUriFromId(hl7:id[1], $maskedIdentifiers)"/>
        <xsl:variable name="author" select="(ancestor-or-self::*/hl7:author/*[hl7:id[@root = $oidUZIPersons]])[1]" as="element()"/>
        <xsl:variable name="idAuthor" select="local:getUriFromId($author/hl7:id[@root = $oidUZIPersons], $maskedIdentifiers)"/>
    ...
    <xsl:template match="hl7:ContraIndication | hl7:ObservationIntolerance" mode="allergyintolerance" as="element(f:entry)*">
        <!-- Get AllergyIntolerance (contra-indicaties / intoleranties) -->
        <xsl:param name="patient" as="element()"/>
